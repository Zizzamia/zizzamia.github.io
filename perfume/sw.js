...
const PERFUME_PRECACHE = [
  ...
  'https://zizzamia.github.io/perfume/assets/SourceSansPro-Regular.woff2',
  'https://zizzamia.github.io/perfume/assets/OpenSans-Regular.woff2'
];
...
self.addEventListener('fetch', async event => {
  if (new URL(event.request.url).origin !== 'https://zizzamia.github.io') {
    return;
  }
  event.respondWith(
    (async function () {
